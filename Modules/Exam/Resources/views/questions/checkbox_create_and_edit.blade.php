                ...
                <div class="card-body">
                    <form id="submit-form" action="{{ isset($question) ? route('backstage.questions.update', $question) :route('backstage.questions.store') }}" method="POST" class="form-horizontal" enctype="multipart/form-data">
                        ...
                        <div class="form-group row mb-3">
                            ...
                            <div class="col-10">
                                <textarea id="explain" name="explain" data-toggle="maxlength" class="form-control" maxlength="225" rows="3" placeholder="请填写试题解析内容">{{ $question->explain ?? old('explain') }}</textarea>
                            </div>
                        </div>
